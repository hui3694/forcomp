<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pm_edit.aspx.cs" Inherits="DTcms.Web.admin.user.pm_edit" %>
...
<body class="mainbody">
    ...
    <div class="tab-content">
      ...
      <dl>
        <dt>籍贯</dt>
        <dd>
          <asp:TextBox ID="txtOrigin" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*</span>
        </dd>
      </dl>
        <dl>
        ...
        <dt>公司名</dt>
        <dd>
          <asp:TextBox ID="txtComName" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*</span>
        </dd>
      </dl>
        <dl>
        <dt>职位</dt>
        <dd>
          <asp:TextBox ID="txtJob" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*</span>
        </dd>
      </dl>
        <dl>
        <dt>入职年份</dt>
        <dd>
          <asp:TextBox ID="txtYear" runat="server" CssClass="input normal" datatype="*" sucmsg=" "></asp:TextBox>
          <span class="Validform_checktip">*</span>
        </dd>
      </dl>
      <dl>
        <dt>工牌照片</dt>
        <dd>
          <asp:TextBox ID="jobImg" runat="server" CssClass="input normal upload-path" />
      ...
      <dl>
        ...
        <dd id="Dd1" class="imgdiv" runat="server" visible="false">
