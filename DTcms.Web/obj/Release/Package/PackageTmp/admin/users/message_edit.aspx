...
<script type="text/javascript">
    $(function () {
        ...
        $("#form1").initValidform();
        //编辑器
        UE.getEditor('txtContent', { toolbars: [['FullScreen', 'Source', 'bold', 'italic', 'underline', 'test', 'fontfamily', 'fontsize', 'forecolor', 'backcolor', 'insertimage', '|', 'insertorderedlist', 'insertunorderedlist', 'indent', 'justifyleft', 'justifycenter', 'justifyright', 'removeformat', 'help']], elementPathEnabled: false, wordCount: false });
    });
</script>
</head>
...
<div class="tab-content">
  ...
  <div id="div_add" runat="server">
      ...
      <dl>
        <dt>短信内容</dt>
        <dd>
          <textarea id="txtContent" style="height:200px; width:100%;" runat="server"></textarea>
        </dd>
      </dl>
  </div>
</div>
