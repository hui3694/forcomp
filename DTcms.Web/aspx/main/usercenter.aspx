...
override protected void OnInit(EventArgs e)
{
	...
	templateBuilder.Append(linkurl("userforum","topic"));

	templateBuilder.Append("\">论坛贴子</a>\r\n</li>\r\n<li>\r\n<a href=\"");
	...
	templateBuilder.Append("\r\n</b>条\r\n</dd>\r\n</dl>\r\n<dl>\r\n<dt>论坛金币：</dt>\r\n<dd>\r\n<b id=\"CreditValue\" class=\"red\">\r\n0\r\n</b>币 <a href=\"");
	templateBuilder.Append(linkurl("usercredit","convert"));

	templateBuilder.Append("\" style=\"color: #B92C00;font-weight: bold;\">>>[兑换帐户积分]</a>\r\n</dd>\r\n</dl>\r\n<script type=\"text/javascript\">\r\n$.ajax({\r\nsuccess: function (responseText, statusText) {\r\nif (responseText.error) {\r\n$(\"#CreditValue\").html(0);\r\nreturn;\r\n}\r\nelse {\r\nfor (var i = 0; i < responseText.length; i++) {\r\n$(\"#CreditValue\").html(responseText[i].Credit);\r\n}\r\n}\r\n},\r\nerror: function () {\r\n$(\"#CreditValue\").html(0);\r\n},\r\ncomplete: function () {\r\n},\r\nurl: \"/plugins/forum/handler/submit_ajax.ashx?action=users&user_ids=\" + ");
