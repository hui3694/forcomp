...
namespace DTcms.Web.Plugin.Forum.DAL
{
    ...
    //------------------------------------------------------
    public partial class Forum_MyTopic
    {
        private string databaseprefix; //数据库表名前缀
        private string column;
        public Forum_MyTopic(string _databaseprefix)
        {
            databaseprefix = _databaseprefix;
            this.column = " Id, TopicId, UserId  ";
        }
        #region 基本方法================================
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from " + databaseprefix + "Forum_MyTopic");
            strSql.Append(" where ");
            strSql.Append(" Id = @Id  ");
        ...
        public int GetCount(string strWhere)
        {
            ...
            strSql.Append(" from " + databaseprefix + "Forum_MyTopic");
            if (strWhere.Trim() != "")
            {
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Model.Forum_MyTopic model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into " + databaseprefix + "Forum_MyTopic(");
            strSql.Append("TopicId,UserId");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.Forum_MyTopic model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "Forum_MyTopic set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update " + databaseprefix + "Forum_MyTopic set " + strValue);
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + databaseprefix + "Forum_MyTopic ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Model.Forum_MyTopic GetModel(int Id)
        {
        ...
        /// 得到一个对象实体
        /// </summary>				
        public Model.Forum_MyTopic DataRowToModel(DataRow row)
        {

            if (row != null)
            {
                Model.Forum_MyTopic model = new Model.Forum_MyTopic();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM " + databaseprefix + "Forum_MyTopic ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
