...
{	
    ...
    public partial class group_list : Web.UI.ManagePage
	{
        ...
        private void RptBind()
        {
            ...
            this.rptList.DataSource = bll.GetList(100, " 1=1 ", " [Type] asc ");
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("Forum_Group_page_size", "DTcmsPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            ChkAdminLevel("plugin_forum_group", DTEnums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.Forum_Group bll = new BLL.Forum_Group();
            ...
            AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), "删除dt_Forum_Group" 
