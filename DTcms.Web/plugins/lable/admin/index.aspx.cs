...
namespace DTcms.Web.Plugin.Lable.admin
{
    public partial class index : Web.UI.ManagePage
    {
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("index.aspx", "keywords={0}", keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(DTEnums.ActionEnum.Delete.ToString(), "删除标签内容成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
