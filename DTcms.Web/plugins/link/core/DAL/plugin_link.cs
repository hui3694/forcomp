...
namespace DTcms.DAL
{
    ...
    /// 数据库访问层
    /// </summary>
    public partial class plugin_link
    {
        private string column;
        private string databaseprefix; 
        public plugin_link(string _databaseprefix)
        {
        ...
        public bool Exists(int id)
        {
            ...
            return DbHelperSQL.Exists("select count(1) from [" + databaseprefix + "plugin_link] where id=@id", parameters);
        }
        /// <summary>
        /// 返回数据总数
        /// </summary>
        ...
        public int GetCount(string strWhere)
        {
            ...
            strSql.Append("select count(*) as H from [" + databaseprefix + "plugin_link]");
            if ("" != strWhere.Trim())
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [" + databaseprefix + "plugin_link](");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [" + databaseprefix + "plugin_link] set " + strValue);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [" + databaseprefix + "plugin_link] set ");
        ...
        {
            Model.plugin_link model = GetModel(id);
            if (model != null)
            {
                SqlParameter[] parameters = {
            		new SqlParameter("@id", SqlDbType.Int,4)
                ...
                parameters[0].Value = id;
                int rows = DbHelperSQL.ExecuteSql("delete from [" + databaseprefix + "plugin_link] where id=@id", parameters);
                if (rows > 0)
                {
                    return true;
                }
        ...
        public Model.plugin_link GetModel(int id)
        {
            ...
            parameters[0].Value = id;
            DataSet ds = DbHelperSQL.Query("select " + this.column + " from [" + databaseprefix + "plugin_link] where id=@id", parameters);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select " + this.column + " from [" + databaseprefix + "plugin_link]");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int Top, string strWhere)
        {
            ...
            strSql.Append(this.column + " from [" + databaseprefix + "plugin_link]");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [" + databaseprefix + "plugin_link]");
            if ("" != strWhere.Trim())
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        /// <returns>Model.plugin_link</returns>
        private Model.plugin_link DataRowToModel(DataRow row)
        {
