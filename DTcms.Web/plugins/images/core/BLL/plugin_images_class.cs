...
namespace DTcms.BLL
{
    ...
    /// 业务逻辑层
    /// </summary>
    public class plugin_images_class
    {
        private readonly Model.siteconfig siteConfig = new BLL.siteconfig().loadConfig();
        private readonly DAL.plugin_images_class dal;

        public plugin_images_class()  
        {
              dal = new DAL.plugin_images_class(siteConfig.sysdatabaseprefix);
        }
