...
namespace DTcms.Web.admin.settings
{
    public partial class sys_config : Web.UI.ManagePage
    {
        ...
        private void ShowInfo()
        {
            ...
            smssenderror.Text = model.smssenderror;
            ...
            smsqueryresult.Text = model.smsqueryresult;
            smsqueryerror.Text = model.smsqueryerror;
            smsquerylable.Text = model.smsquerylable;
        ...
        private void SetSmsCount()
        {
            ...
            else
            {
                ...
                labSmsCount.InnerText = siteConfig.smsqueryformat.Substring(start, len).Replace("{0}", total.ToString());
            }
        }
        #endregion
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                model.smssenderror = smssenderror.Text.Trim(); 
                ...
                model.smsqueryresult = smsqueryresult.Text.Trim();
                model.smsqueryerror = smsqueryerror.Text.Trim();
                model.smsquerylable = smsquerylable.Text.Trim();
                ...
                model.cachekey = txtCacheKey.Text.Trim();
