    ...
    <div class="bd">
        <div class="box">
          ...
          <dl>
            ...
            <dd>
              ...
              <span class="Validform_checktip">当响应结果类型为“文本”时，支持正则表达式，为空则不查询</span>
            </dd>
          </dl>
          <dl>
            <dt>错误查询</dt>
            <dd>
              <asp:TextBox ID="smssenderror" runat="server" CssClass="input txt" />
              <span class="Validform_checktip">当响应结果类型为“文本”时，支持正则表达式，为空则不查询</span>
            </dd>
          </dl>
          <dl>
        ...
        <div class="box hide">
          ...
          <dl>
            <dt>结果查询</dt>
            <dd>
              <asp:TextBox ID="smsqueryresult" runat="server" CssClass="input txt" />
              <span class="Validform_checktip">当响应结果类型为“文本”时，支持正则表达式，为空则不查询</span>
            </dd>
          </dl>
          <dl>
            <dt>错误查询</dt>
            <dd>
              <asp:TextBox ID="smsqueryerror" runat="server" CssClass="input txt" />
              <span class="Validform_checktip">当响应结果类型为“文本”时，支持正则表达式，为空则不查询</span>
            </dd>
          </dl>
          <dl>
            <dt>成功状态标识</dt>
            <dd>
              <asp:TextBox ID="smsquerylable" runat="server" CssClass="input txt" />
              <span class="Validform_checktip">*如：0或succeed</span>
            </dd>
          </dl>
          <dl>
...
<div class="tab-content" style="display:none">
    ...
    <dl>
        ...
        <dd>
            ...
            <span class="Validform_checktip">*开启后需重新重新应用模板</span>
        </dd>
    </dl>
    <div id="divCache">
        <dl>
            ...
            <dd>
              ...
              <span class="Validform_checktip">*单位（分钟）默认 3</span>
            </dd>
        </dl>
        <dl>
            <dt>缓存标识</dt>
            <dd>
              <asp:TextBox ID="txtCacheKey" runat="server" CssClass="input" datatype="*" sucmsg=" " />
              <span class="Validform_checktip">*默认为“CacheKey”</span>
            </dd>
        </dl>
    </div>
    <script type="text/javascript">
