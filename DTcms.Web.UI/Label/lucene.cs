...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        /// <returns></returns>
        protected DataTable get_lucene_list(int top, int site_id, int channel_id, int category_id, string keywords)
        {
        ...
        /// <returns></returns>
        protected DataTable get_lucene_list(int pageSize, int pageIndex, int site_id, int channel_id, int category_id, string keywords, out int recordCount)
        {
            recordCount = 0;
            DataTable dt = new DataTable();
