...
namespace DTcms.DAL
{
    ...
    public partial class user_sign
    {
        ...
        public user_sign(string _databaseprefix)
        {
            this.databaseprefix = _databaseprefix;
            this.column = "id,user_id,time,day";
        }
        ...
        public bool Exists(int id)
        {
            ...
            return DbHelperSQL.Exists("select count(1) from [" + databaseprefix + "user_sign] where id=@id", parameters);
        }
        /// <summary>
        /// 返回数据总数
        /// </summary>
        ...
        public int GetCount(string strWhere)
        {
            ...
            strSql.Append("select count(*) as H from [" + databaseprefix + "user_sign]");
            if ("" != strWhere.Trim())
            {
        ...
        {
            DbHelperSQL.ExecuteSql("update [" + databaseprefix + "user_sign] set " + strValue + " where id=" + id);
        }
        #endregion
        ...
        public bool Delete(int id)
        {
            ...
            parameters[0].Value = id;
            int rows = DbHelperSQL.ExecuteSql("delete from [" + databaseprefix + "user_sign] where id=@id", parameters);
            if (rows > 0)
            {
                return true;
            }
        ...
        public Model.user_sign GetModel(int id)
        {
            ...
            parameters[0].Value = id;
            DataSet ds = DbHelperSQL.Query("select " + this.column + " from [" + databaseprefix + "user_sign] where id=@id", parameters);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(this.column + " from [" + databaseprefix + "user_sign]");
            if ("" != strWhere.Trim())
            {
              strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [" + databaseprefix + "user_sign]");
            if ("" != strWhere.Trim())
            {
                strSql.Append(" where " + strWhere);
            }
