...
namespace DTcms.DAL
{
    ...
    /// 数据库访问层
    /// </summary>
    public partial class call_pm
    {
        private string column;
        private string databaseprefix; 
        public call_pm(string _databaseprefix)
        {
            this.databaseprefix = _databaseprefix;
            this.column = "id,user_id,call_id,time";
        }
        ...
        public bool Exists(int id)
        {
            ...
            return DbHelperSQL.Exists("select count(1) from [" + databaseprefix + "call_pm] where id=@id", parameters);
        }
        /// <summary>
        /// 返回数据总数
        /// </summary>
        ...
        public int GetCount(string strWhere)
        {
            ...
            strSql.Append("select count(*) as H from [" + databaseprefix + "call_pm]");
            if ("" != strWhere.Trim())
            {
        ...
        {
            DbHelperSQL.ExecuteSql("update [" + databaseprefix + "call_pm] set " + strValue + " where id=" + id);
        }
        #endregion
        ...
        public bool Delete(int id)
        {
            ...
            parameters[0].Value = id;
            int rows = DbHelperSQL.ExecuteSql("delete from [" + databaseprefix + "call_pm] where id=@id", parameters);
            if (rows > 0)
            {
                return true;
            }
        ...
        public Model.call_pm GetModel(int id)
        {
            SqlParameter[] parameters = {
            		new SqlParameter("@id", SqlDbType.Int,4)
            };
            parameters[0].Value = id;
            DataSet ds = DbHelperSQL.Query("select " + this.column + " from [" + databaseprefix + "call_pm] where id=@id", parameters);
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(this.column + " from [" + databaseprefix + "call_pm]");
            if ("" != strWhere.Trim())
            {
              strSql.Append(" where " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from [" + databaseprefix + "call_pm]");
            if ("" != strWhere.Trim())
            {
                strSql.Append(" where " + strWhere);
            }
