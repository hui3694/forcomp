...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li runat="server" id="addBtnPannel"><a class="add" href="article_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>&backurl=<%=DTRequest.GetUrlParameter() %>"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <ItemTemplate>
    <tr>
      ...
      <td><a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>"><%#Eval("title")%></a></td>
      ...
      <td align="center">
        <a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Copy %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>">复制</a>
        <a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>">修改</a>
      </td>
    </tr>
  </ItemTemplate>
  <FooterTemplate>
  ...
  <ItemTemplate>
      <li>
        <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
          ...
          <h1><span><a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>"><%#Eval("title")%></a></span></h1>
          <div class="remark">
          ...
          <div class="foot">
            ...
            <a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>" title="编辑" class="edit">编辑</a>
            <a href="article_edit.aspx?action=<%#DTEnums.ActionEnum.Copy %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>&backurl=<%=DTRequest.GetUrlParameter() %>" title="复制" class="copy">复制</a>
          </div>
        </div>
      </li>
  </ItemTemplate>
