...
<script type="text/javascript">
    $(function () {
        ...
        $(".upload-album").InitUploader({ btntext: "批量上传", multiple: true, water: true, width:<%=chlmodel.width %>, height:<%=chlmodel.height %>, thumbnail: true, filesize: "<%=siteConfig.imgsize %>", sendurl: "../../tools/upload_ajax.ashx", swf: "../../scripts/webuploader/uploader.swf" });
...
<div class="tab-content">
  ...
  <dl>
    <dt>Tags标签</dt>
    <dd>
      <asp:TextBox ID="txtTags" runat="server" CssClass="input" TextMode="MultiLine" datatype="*0-255" sucmsg=" "></asp:TextBox>
    </dd>
  </dl>
  <dl>
    <dt>封面图片</dt>
