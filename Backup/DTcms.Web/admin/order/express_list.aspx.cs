    ...
    public partial class express_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //添加权限
                if (!ChkAuthority("order_express", DTEnums.ActionEnum.Add.ToString()))
                {
                    this.addBtnPannel.Visible = false;
                }
                //修改权限
                if (!ChkAuthority("order_express", DTEnums.ActionEnum.Edit.ToString()))
                {
                    this.editBtnPannel.Visible = false;
                }
                //删除权限
                if (!ChkAuthority("order_express", DTEnums.ActionEnum.Delete.ToString()))
                {
