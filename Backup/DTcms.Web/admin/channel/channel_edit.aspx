...
<div class="tab-content" style="display:none;">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="cbIsRecycle" runat="server" />
      </div>
  ...
  <dl>
    <dt>缩略图生成尺寸</dt>
    <dd>
      <asp:TextBox ID="txtHeight" runat="server" CssClass="input small" datatype="n" sucmsg=" " Text="0" /> ×
      <asp:TextBox ID="txtWidth" runat="server" CssClass="input small" datatype="n" sucmsg=" " Text="0" /> px
      <span class="Validform_checktip">*左边高度，右边宽度，0为不限制缩略图</span>
    </dd>
  </dl>
</div>
<div class="tab-content" style="display:none;">
